...
<div className='container my-5'>
      ...
      <div className="col-md-6">
        <h2 className="featurette-heading fw-normal lh-1 my-5">Smart Integrated Renewable Energy <span className="text-body-secondary">It’ll blow your mind.</span></h2>
        <p className="lead">Smart integrated renewable energy systems combine advanced technologies, such as IoT and AI, to optimize the generation, storage, and distribution of renewable energy, maximizing efficiency and reliability while reducing carbon footprint.
These systems enable seamless integration of various renewable sources, like solar and wind, with energy storage solutions and smart grid infrastructure, revolutionizing the way energy is generated, consumed, and managed.</p>
    ...
    <hr />
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading fw-normal lh-1 my-5">Oh yeah, it’s that good. <span class="text-body-secondary">See for yourself.</span></h2>
